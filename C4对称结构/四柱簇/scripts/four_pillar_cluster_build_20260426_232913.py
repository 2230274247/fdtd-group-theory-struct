...
META = {
  "category": "C4对称结构",
  "name": "四柱簇",
  "safe": "four_pillar_cluster",
  "symmetry": "C4，旋转 90° 重合",
  "reason": "比十字更离散，适合 cluster 路线",
  "breaks": "改单个柱子、对边成对变化",
  "period_um": 0.9,
  "height_um": 0.42,
  "substrate_um": 1.0,
...
PATHS = {
  "folder": "H:\\FDTD outcome\\struct\\C4对称结构\\四柱簇",
  "fsp": "H:\\FDTD outcome\\struct\\C4对称结构\\四柱簇\\four_pillar_cluster_CodexAstra_20260426_232913.fsp",
  "png": "H:\\FDTD outcome\\struct\\C4对称结构\\四柱簇\\four_pillar_cluster_prelim_T_20260426_232913.png",
  "py": "H:\\FDTD outcome\\struct\\C4对称结构\\四柱簇\\four_pillar_cluster_build_20260426_232913.py",
  "note": "H:\\FDTD outcome\\struct\\C4对称结构\\四柱簇\\four_pillar_cluster_note_20260426_232913.md",
  "csv": "H:\\FDTD outcome\\struct\\C4对称结构\\四柱簇\\four_pillar_cluster_prelim_T_20260426_232913.csv",
  "result": "H:\\FDTD outcome\\struct\\C4对称结构\\四柱簇\\four_pillar_cluster_result_20260426_232913.json"
}
...
def add_common(fdtd):
    ...
    try:
        fdtd.setglobalmonitor("frequency points", 501)
    except Exception:
        pass
    add_rect(fdtd, "SiO2_substrate", 0, 0, P, P, -sub, 0, "SiO2 (Glass) - Palik")
    fdtd.addplane()
...
def build_geometry(fdtd):
    ...
    if safe == "dual_pillars":
        for x in [-0.18*UM, 0.18*UM]:
            add_circle(fdtd, "Si_pillar", x, 0, 0.12*UM, 0.12*UM, 0, H, Si)
        ...
        add_rect(fdtd, "Si_ellipse_L_rect_approx", -0.18*UM, 0, 0.13*UM, 0.40*UM, 0, H, Si, -25)
        add_rect(fdtd, "Si_ellipse_R_rect_approx",  0.18*UM, 0, 0.13*UM, 0.40*UM, 0, H, Si, 25)
    elif safe == "cross":
        ...
        add_circle(fdtd, "Si_hex_block_circular_approx", 0, 0, 0.31*UM, 0.31*UM, 0, H, Si)
