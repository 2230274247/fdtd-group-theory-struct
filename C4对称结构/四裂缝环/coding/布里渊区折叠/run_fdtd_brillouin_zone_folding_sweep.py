...
MOTIF_OBJECT_NAMES = ('Si_outer_ring', 'air_inner_ring', 'air_slit')
...
CONFIG = dict(
    ...
    SYMMETRY_NAME="C4对称结构",
    STRUCTURE_CN_NAME="四裂缝环",
    PERTURBATION_NAME="布里渊区折叠",
    GROUP_PATH="C4对称结构 -> 2-cell BZF supercell -> gap perturbation deltaL",
    START_NM=START_NM,
    END_NM=END_NM,
    STEP_NM=STEP_NM,
