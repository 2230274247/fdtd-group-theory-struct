...
MOTIF_OBJECT_NAMES = ('Si_ellipse_L_rect_approx', 'Si_ellipse_R_rect_approx', 'Si_ellipse_L', 'Si_ellipse_R')
...
CONFIG = dict(
    ...
    GROUP_PATH="C2对称结构 -> 2-cell BZF supercell -> gap perturbation deltaL",
    START_NM=START_NM,
    END_NM=END_NM,
    STEP_NM=STEP_NM,
