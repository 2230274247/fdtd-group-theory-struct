...
CONFIG = dict(
    ...
    PERTURBATION_NAME='长轴差扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='set_y_span_delta',
    OPERATION_DESCRIPTION='只减小右侧近似椭圆的 y span，形成长轴差。',
    TARGET_INDICES=(1,),
    VALUE_NAME='long_axis_difference',
    SCAN_LABEL='ellipse_long_axis_difference',
    USER_GUIDE=['实际对象为旋转矩形近似椭圆；长轴对应 y span = 0.400 um。'],
