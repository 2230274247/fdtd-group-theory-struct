...
CONFIG = dict(
    ...
    PERTURBATION_NAME='短轴差扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='set_x_span_delta',
    OPERATION_DESCRIPTION='只减小右侧近似椭圆的 x span，形成短轴差。',
    TARGET_INDICES=(1,),
    VALUE_NAME='short_axis_difference',
    SCAN_LABEL='ellipse_short_axis_difference',
    USER_GUIDE=['实际对象为旋转矩形近似椭圆；短轴对应 x span = 0.130 um。'],
