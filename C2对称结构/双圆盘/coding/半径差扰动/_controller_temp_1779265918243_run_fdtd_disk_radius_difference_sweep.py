...
CONFIG.update({'mesh_accuracy': 1, 'MESH_ACCURACY': 1, 'dt_stability_factor': -1, 'DT_STABILITY_FACTOR': -1, 'auto_shutoff_min': 1e-07, 'AUTO_SHUTOFF_MIN': 1e-07})
