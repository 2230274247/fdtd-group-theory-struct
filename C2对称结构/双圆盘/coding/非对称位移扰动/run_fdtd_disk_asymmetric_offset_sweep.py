...
CONFIG = dict(
    ...
    PERTURBATION_NAME='非对称位移扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='offset_single',
    OPERATION_DESCRIPTION='只移动右侧 Si_disk 的 x 坐标。',
    TARGET_INDICES=(2,),
    VALUE_NAME='right_disk_dx',
    SCAN_LABEL='disk_asymmetric_offset',
    USER_GUIDE=['母版双盘中心距 0.360 um；dx 为右盘额外 +x 位移。'],
    OFFSET_AXIS='x',
