...
CONFIG = dict(
    ...
    PERTURBATION_NAME='左右位置差扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='offset_single',
    OPERATION_DESCRIPTION='只移动右侧 Si_pillar 的 x 坐标，左柱保持母版位置。',
    TARGET_INDICES=(2,),
    OFFSET_AXIS='x',
    VALUE_NAME='right_pillar_dx',
    SCAN_LABEL='pillar_position_difference',
    ...
    USER_GUIDE=['母版两柱中心距 0.360 um；dx 为右柱额外 +x 位移。'],
)
