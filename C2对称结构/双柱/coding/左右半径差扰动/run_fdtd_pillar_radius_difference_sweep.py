...
CONFIG = dict(
    ...
    PERTURBATION_NAME='左右半径差扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='set_radius_delta',
    OPERATION_DESCRIPTION='只把右侧 Si_pillar 半径从母版值减小 delta，左柱保持 0.120 um。',
    TARGET_INDICES=(2,),
    VALUE_NAME='radius_difference',
    SCAN_LABEL='pillar_radius_difference',
    ...
    MIN_RADIUS_NM=40.0,
    USER_GUIDE=['母版柱半径 0.120 um；delta 越大，右柱越小。'],
)
