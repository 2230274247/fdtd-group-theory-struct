...
CONFIG = dict(
    ...
    PERTURBATION_NAME='梁偏移扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='offset_single',
    OPERATION_DESCRIPTION='只移动右侧 Si_beam 的 x 坐标。',
    TARGET_INDICES=(2,),
    VALUE_NAME='right_beam_dx',
    SCAN_LABEL='beam_offset',
    USER_GUIDE=['母版两梁中心 x = -0.210 / +0.210 um；dx 为右梁额外 +x 位移。'],
    OFFSET_AXIS='x',
