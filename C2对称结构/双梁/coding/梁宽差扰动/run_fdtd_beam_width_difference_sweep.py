...
CONFIG = dict(
    ...
    PERTURBATION_NAME='梁宽差扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='set_y_span_delta',
    OPERATION_DESCRIPTION='只减小右侧 Si_beam 的 y span，形成梁宽差。',
    TARGET_INDICES=(2,),
    VALUE_NAME='beam_width_difference',
    SCAN_LABEL='beam_width_difference',
    USER_GUIDE=['母版梁宽 y span = 0.120 um；delta 越大右梁越窄。'],
