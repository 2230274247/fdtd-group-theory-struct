...
CONFIG = dict(
    ...
    PERTURBATION_NAME='梁长差扰动',
    GROUP_PATH='C2 -> C1',
    OPERATION='set_x_span_delta',
    OPERATION_DESCRIPTION='只减小右侧 Si_beam 的 x span，形成梁长差。',
    TARGET_INDICES=(2,),
    VALUE_NAME='beam_length_difference',
    SCAN_LABEL='beam_length_difference',
    USER_GUIDE=['母版梁长 x span = 0.300 um；delta 越大右梁越短。'],
