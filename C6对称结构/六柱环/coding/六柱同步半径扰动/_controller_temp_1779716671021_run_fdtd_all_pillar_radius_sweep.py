...
CONFIG.update({'auto_retry_enabled': True, 'AUTO_RETRY_ENABLED': True, 'auto_retry_max': 1, 'AUTO_RETRY_MAX': 1, 'quality_t_limit': 1.03, 'QUALITY_T_LIMIT': 1.03, 'quality_ripple_limit': 0.12, 'QUALITY_RIPPLE_LIMIT': 0.12})
