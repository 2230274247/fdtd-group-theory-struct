...
CONFIG.update({'mesh_accuracy': 1, 'MESH_ACCURACY': 1, 'simulation_time_fs': 50000, 'SIMULATION_TIME_FS': 50000, 'auto_shutoff_min': 1e-07, 'AUTO_SHUTOFF_MIN': 1e-07, 'dt_stability_factor': 0.99, 'DT_STABILITY_FACTOR': 0.99, 'auto_retry_enabled': True, 'AUTO_RETRY_ENABLED': True, 'autoretryenabled': True, 'auto_retry_max': 'adaptive', 'AUTO_RETRY_MAX': 'adaptive', 'autoretrymax': 'adaptive', 'quality_t_limit': 1.03, 'QUALITY_T_LIMIT': 1.03, 'qualitytlimit': 1.03, 'quality_ripple_limit': 0.12, 'QUALITY_RIPPLE_LIMIT': 0.12, 'qualityripplelimit': 0.12, 'simulation_time_s': 5e-11, 'SIMULATION_TIME_S': 5e-11})
