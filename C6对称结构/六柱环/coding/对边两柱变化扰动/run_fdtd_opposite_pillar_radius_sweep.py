...
CONFIG = dict(
    ...
    PERTURBATION_NAME="对边两柱变化扰动",
    GROUP_PATH="C6 -> C2",
    OBJECT_NAME="Si_pillar",
    OPERATION="set_radius",
    OPERATION_DESCRIPTION="同步改变相对的第 1 与第 4 个柱子半径，保留 180 度旋转趋势。",
    TARGET_INDICES=OPPOSITE_PILLAR_INDICES,
    VALUE_NAME="pillar_radius",
    SCAN_LABEL="opposite_pillar_radius",
